#ifndef RoleManagementDeleget_H
#define RoleManagementDeleget_H

#include <QStyledItemDelegate>
#include <QPushButton>

class RoleManagementDeleget : public QStyledItemDelegate
{
    Q_OBJECT
public:
    explicit RoleManagementDeleget(QObject *parent = 0);
