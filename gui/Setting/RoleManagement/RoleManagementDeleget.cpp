...
RoleManagementDeleget::RoleManagementDeleget(QObject *parent)
...
void RoleManagementDeleget::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
    ...
    // 选择栏
    if (index.column() == (int)RoleManagementModel::Column::CheckBox) {
    ...
    // 编辑栏
    else if(index.column() == (int)RoleManagementModel::Column::Edit) {
        // 计算按钮显示区域
...
bool RoleManagementDeleget::editorEvent(QEvent *event, QAbstractItemModel *model, const QStyleOptionViewItem &option, const QModelIndex &index)
{
    ...
    if (index.column() == (int)RoleManagementModel::Column::Edit) {
        m_nType = -1;
        bool bRepaint = false;
...
QWidget *RoleManagementDeleget::createEditor(QWidget *parent, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
    Q_UNUSED(parent);
    Q_UNUSED(option);
    Q_UNUSED(index);
...
void RoleManagementDeleget::setEditorData(QWidget *editor, const QModelIndex &index) const
{
    Q_UNUSED(editor);
    Q_UNUSED(index);
}

void RoleManagementDeleget::setModelData(QWidget *editor, QAbstractItemModel *model, const QModelIndex &index) const
{
    Q_UNUSED(editor);
    Q_UNUSED(model);
    Q_UNUSED(index);
