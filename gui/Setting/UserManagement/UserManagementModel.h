...
class UserManagementModel : public QAbstractTableModel
{
    Q_OBJECT
public:
    explicit UserManagementModel(QObject *parent = 0);
    ...
    enum class Column : int {
        CheckBox = 0, SerialNumber, LoginName,
        GenerateTime, LoginTime, LastLoginTime,
        Role, Edit, Count };

private:
    QList<UserBean> m_userBeanList;
};
